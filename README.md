...
*Ver 1.0.4*: This is the fifth version of this project. Here UI improvement has been done. Instead of having both sender and receiver section side by side in case of a desktop / laptop and one below the other in case of a mobile, the Tab System has been implemented. By clicking the sender button (tab) we can go to the sender's section and by clicking the receiver button (tab) we can go to the receiver's section.
